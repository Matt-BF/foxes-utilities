...
RUN  export VERSION=`google-chrome --version | awk -F " " '{print $3}'| awk -F "." '{print $1 "." $2 "." $3}'` && export FULLVERSION=`curl -sS https://chromedriver.storage.googleapis.com/LATEST_RELEASE_$VERSION`
# Installing Unzip
